...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . krtg4hkewq [ 0 ] ) , 0 , 0 ,
68 } , { ( char_T * ) ( & rtDW . pydj2pulvz ) , 0 , 0 , 13 } , { ( char_T * )
( & rtDW . kvnsin1yg3 . LoggedData [ 0 ] ) , 11 , 0 , 18 } , { ( char_T * ) (
& rtDW . e3y0cazldt ) , 6 , 0 , 5 } , { ( char_T * ) ( & rtDW . njpxizyule )
, 8 , 0 , 18 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . Sample_Time ) , 0 , 0 , 13 } } ; static
